    ...
    <Container fluid className="vh-100 d-flex flex-column bg-light">
      <Row className="flex-grow-1 overflow-hidden">
        ...
        <Col
          md={showSidebar ? 9 : 12}
          sm={12}
          className="d-flex flex-column justify-content-between align-items-center bg-white"
        >
          {/* Chat Area */}
          <div className="w-100 pt-3 px-3 flex-grow-1 overflow-auto" style={{ maxHeight: "calc(100vh - 150px)" }}>
              ...
              >
                <div
                  className={`p-2 rounded shadow-sm ${
                    message.sender === "user" ? "bg-dark text-white" : "bg-light text-dark"
                  }`}
          ...
          {/* Input Area */}
          <div className="w-100 p-3 bg-light border-top">
            <InputGroup>
              <FormControl
                as="textarea"
